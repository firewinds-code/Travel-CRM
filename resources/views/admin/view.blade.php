<form action="{{route('admin.update')}}" method="post" id="manageRequests" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" style="width: 100%;" name="process"
                                        ...
                                        @foreach ($process as $key => $process)
                                            <option value="{{ $process }}"@if ($process == $query->process) selected @endif>{{ $process }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="radioPrimary1" name="advance_required"
                                                {{ $query->advance_required == 'Yes' ? 'checked' : '' }} value="Yes">
                                            <label for="radioPrimary1">Yes
                                            </label>
                                        </div>
                                        <div class="icheck-danger d-inline">
                                            <input type="radio" id="radioPrimary2" name="advance_required"
                                                value="No" {{ $query->advance_required == 'No' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4" id="amount_div">
                                <div class="form-group">
                                    ...
                                    <input name="amount" type="number" class="form-control" id="amount" value="{{ $query->amount }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="icheck-success d-inline">
                                          <input type="radio" id="radioaproval1" name="approval_status"  value="Approved" {{ $query->approval_status == 'Approved' ? 'checked' : '' }}>
                                          <label for="radioaproval1" >Approved
                                          </label>
                                        </div>
                                        <div class="icheck-danger d-inline">
                                          <input type="radio" id="radioaproval2" name="approval_status" value="Rejected"  {{ $query->approval_status == 'Rejected' ? 'checked' : '' }}>
                                          <label for="radioaproval2" >Rejected
                                          </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" id="remarks" class="form-control" rows="1" placeholder="Enter Remarks">{{ $query->remarks }}</textarea>
                                </div>
                            </div>
                        </div>
