<form action="{{route('approver.update')}}" method="post" id="manageRequests" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="icheck-success d-inline">
                                          <input type="radio" id="radioaproval1" name="approval_status"  value="Approved">
                                          <label for="radioaproval1" >Approved
                                          </label>
                                        </div>
                                        <div class="icheck-danger d-inline">
                                          <input type="radio" id="radioaproval2" name="approval_status" value="Rejected">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" id="remarks" class="form-control" rows="1" placeholder="Enter Remarks"></textarea>
                                </div>
                            </div>
                        </div>
